 ...
 *
 * $Id: functions_gedcom.php,v 1.1.1.1 2007/01/21 05:01:28 tallred Exp $
 *
...
/**
 * Remove invalid GEDCOM tags
 *
 * @param unknown_type $irec
 * @return unknown
 */
...
function is_ansi() {
	global $fcontents;
	$status = preg_match("/1 CHAR (ANSI|ANSEL)/", $fcontents);
	if ($status) $fcontents = preg_replace("/1 CHAR (ANSI|ANSEL)/", "1 CHAR UTF-8", $fcontents);
	return $status;
}
...
/**
 * convert ansel text to unicode
 * see http://www.heiner-eichmann.de/gedcom/ans2uni.out
 *
 */
function convert_ansel_unicode($text) {
	$ansel = array (
	"\xA1","\xA2","\xA3","\xA4","\xA5","\xA6","\xA7","\xA8","\xA9","\xAA","\xAB","\xAC","\xAD","\xAE",
	"\xB0","\xB1","\xB2","\xB3","\xB4","\xB5","\xB6","\xB7","\xB8","\xB9","\xBA","\xBC","\xBD",
	"\xC0","\xC1","\xC2","\xC3","\xC4","\xC5","\xC6","\xCF",
	"\xE0","\xE1","\xE2","\xE3","\xE4","\xE5","\xE6","\xE7","\xE8","\xE9","\xEA","\xEB","\xEC","\xED","\xEE","\xEF",
	"\xF0","\xF1","\xF2","\xF3","\xF4","\xF5","\xF6","\xF7","\xF9","\xFA","\xFB","\xFE");
	$unicode = array (
	"\x01\x41","\x00\xD8","\x01\x10","\x00\xDE","\x00\xC6","\x01\x52","\x02\xB9","\x00\xB7","\x26\x6D","\x00\xAE","\x00\xB1","\x01\xA0","\x01\xAF","\x02\xBC",
	"\x02\xBB","\x01\x42","\x00\xF8","\x01\x11","\x00\xFE","\x00\xE6","\x01\x53","\x02\xBA","\x01\x31","\x00\xA3","\x00\xF0","\x01\xA1","\x01\xB0",
	"\x00\xB0","\x21\x13","\x21\x17","\x00\xA9","\x26\x6F","\x00\xBF","\x00\xA1","\x00\xDF",
	"\x03\x09","\x03\x00","\x03\x01","\x03\x02","\x03\x03","\x03\x04","\x03\x06","\x03\x07","\x03\x08","\x03\x0C",
	"\x03\x0A","\xFE\x20","\xFE\x21","\x03\x15","\x03\x0B","\x03\x10",
	"\x03\x27","\x03\x28","\x03\x23","\x03\x24","\x03\x25","\x03\x33","\x03\x32","\x03\x26","\x03\x2E","\xFE\x22","\xFE\x23","\x03\x13");
	$temp = str_replace($ansel, $unicode, $text);
	return $temp;
}
